...
<body class="h-full text-slate-100 flex flex-col items-center justify-center p-4 antialiased selection:bg-indigo-500/30 selection:text-indigo-200">
    ...
    <div class="w-full max-w-md my-8">
        ...
        <!-- Logo & Brand Header -->
        <div class="flex flex-col items-center gap-3 mb-6 text-center animate-fade-in">
        ...
        <div class="glass-card rounded-3xl p-8 border border-indigo-500/10">
            ...
            <div class="mb-6">
                ...
                <p class="text-xs text-slate-400 mt-1">Mulailah menulis ide kreatif dan simpan dengan aman</p>
            </div>
            ...
            <form action="{{ route('register') }}" method="POST" class="space-y-4.5">
                ...
                <!-- Full Name -->
                <div>
                    <label for="name" class="block text-xs font-semibold uppercase tracking-wider text-slate-400 mb-2">Nama Lengkap</label>
                    <div class="relative">
                ...
                <div>
                    <label for="password_confirmation" class="block text-xs font-semibold uppercase tracking-wider text-slate-400 mb-2">Konfirmasi Kata Sandi</label>
                    <div class="relative">
                        <div class="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none text-slate-500">
                            <svg class="w-4.5 h-4.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <input 
                            ...
                            class="block w-full pl-10 pr-4 py-3 bg-slate-900/50 border border-slate-800 focus:ring-indigo-500/30 focus:border-indigo-500/50 rounded-xl text-slate-100 placeholder-slate-550 focus:outline-none focus:ring-2 transition-all text-sm font-medium"
                        >
                    </div>
                </div>
            ...
            <div class="mt-6 text-center border-t border-slate-800/80 pt-5 text-xs text-slate-450 font-medium">
                Sudah memiliki akun AuraNotes? 
                <a href="{{ route('login') }}" class="text-indigo-400 hover:text-indigo-300 font-bold transition-all hover:underline ml-1">Masuk Sekarang</a>
            </div>
